  ...
  return (
    <header role='banner' className='flex justify-between items-center align-middle py-4 px-8 bg-white dark:bg-black w-full z-10 top-0 left-0'>
      ...
      <div className='sm:flex gap-4 hidden'>
        <Link to="/login" className='px-8 py-3 border border-[#6C3BAA] text-[#6c3baa] font-semibold rounded-full hover:cursor-pointer hover:bg-[#6c3baa] hover:text-white dark:text-white'>Log In</Link>
