...
const Newhero = () => {
  return (
    ...
    }} className={`dark:bg-[url(/background-technology-desktop.jpg)] bg-cover bg-center bg-fixed h-[90vh] sm:mt-20 flex justify-center items-center align-middle text-center`}>
