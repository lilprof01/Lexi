      ...
      <div className="w-full flex flex-col justify-center items-center align-middle gap-8">
        {["Beginner", "Intermediate", "Advanced"].map((level) => (
          <div
            ...
            className="py-4 w-[50%] border-2 border-black dark:shadow-md shadow-purple-500 hover:cursor-pointer rounded-full text-2xl flex justify-center items-center align-middle"
          >
            {level}
          </div>
        ))}
