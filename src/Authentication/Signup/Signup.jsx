...
const Signup = () => {
  ...
  return (
    ...
    <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-[#6C3BAA]">Create your Account</h2>
  </div>
      ...
      <div>
        ...
        <div className="mt-2">
          ...
          <select id="age" required className="block w-full rounded-md bg-white px-3 py-1.5 mt-2 text-base text-gray-900 outline-1 outline-gray-300 focus:outline-2 focus:outline-indigo-600 sm:text-sm">
              ...
              <input type="password" id='password' value={password} onChange={(e) => setPassword(e.target.value)} required placeholder='Password' className="block w-full rounded-md bg-white mt-2 px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"/>
        </div>
      </div>

      
      <div>
        <button type="submit" className="flex w-full justify-center rounded-md bg-[#6C3BAA] px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs hover:text-[#6C3BAA] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Sign up</button>
      </div>
    </form>

    <div>
        <h2 className='block w-full rounded-md text-sm/6 font-bold text-center my-5 bg-white px-3 py-1.5 text-[#6C3BAA] outline-1 -outline-offset-1 outline-gray-300 sm:text-sm/6'>Sign up with Google</h2>
        <h2 className='block w-full rounded-md text-sm/6 font-bold text-center my-5 bg-white px-3 py-1.5 text-[#6C3BAA] outline-1 -outline-offset-1 outline-gray-300 sm:text-sm/6'>Sign up with Facebook</h2>
    </div>

    <p className="mt-10 text-center text-sm/6 text-gray-500">
      Already one of us? 
      <a href="#" className="pl-[10px] font-semibold text-[#6C3BAA] hover:text-[#6C3BAA]">Log in to your account</a>
    </p>
  </div>
    </div>
