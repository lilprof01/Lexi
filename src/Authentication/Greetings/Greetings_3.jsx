    ...
    <div>
      {userDetails ? (
        <div>
          ...
          <div className="flex justify-center items-left mt-4 ml-[400px] flex-col">
            ...
            {goals.map((goal) => (
              <button
                ...
                style={{
                  backgroundColor: selectedGoal === goal ? "black" : "red",
                }}
              >
                {goal}
              </button>
          ...
          <Link to="/greetings-4" className="mt-10 ml-[900px] flex w-[150px] justify-center rounded-md bg-[#6C3BAA] px-3 py-2.5 text-sm/6 font-semibold text-white shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Next
          </Link>
        </div>
      ) : (
